...
import com.example.compass_aac.module.LocationUseCaseModule_ProvideLocationUseCaseFactory;
...
import com.example.compass_aac.module.UserApiModule_ProvideLoginApiFactory;
import com.example.compass_aac.module.UserSourceModule;
import com.example.compass_aac.module.UserSourceModule_ProvideUserSourceFactory;
import com.example.compass_aac.module.UserUseCaseModule;
import com.example.compass_aac.module.UserUseCaseModule_ProvideLoginUseCaseFactory;
import com.example.compass_aac.module.UserUseCaseModule_ProvideRegisterUseCaseFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  public static final class Builder {
    ...
    private UserSourceModule userSourceModule;
    ...
    public Builder locationUseCaseModule(LocationUseCaseModule locationUseCaseModule) {
      Preconditions.checkNotNull(locationUseCaseModule);
      return this;
    }
    ...
    public Builder userSourceModule(UserSourceModule userSourceModule) {
      this.userSourceModule = Preconditions.checkNotNull(userSourceModule);
      return this;
    }
    ...
    public MyApplication_HiltComponents.SingletonC build() {
      ...
      if (userSourceModule == null) {
        this.userSourceModule = new UserSourceModule();
      }
      return new SingletonCImpl(applicationContextModule, dataSourceModule, locationModule, userApiModule, userSourceModule);
    }
  }
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(3).add(LocationViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(LoginViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(RegisterViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.example.compass_aac.viewmodel.LocationViewModel", ((Provider) locationViewModelProvider)).put("com.example.compass_aac.viewmodel.LoginViewModel", ((Provider) loginViewModelProvider)).put("com.example.compass_aac.viewmodel.RegisterViewModel", ((Provider) registerViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.example.compass_aac.viewmodel.RegisterViewModel 
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private final UserSourceModule userSourceModule;
    ...
    private Provider<LocationDataSource> provideLocationSourceProvider;
    ...
    private SingletonCImpl(ApplicationContextModule applicationContextModuleParam,
        ...
        UserApiModule userApiModuleParam, UserSourceModule userSourceModuleParam) {
      this.dataSourceModule = dataSourceModuleParam;
      this.locationModule = locationModuleParam;
      this.applicationContextModule = applicationContextModuleParam;
      this.userSourceModule = userSourceModuleParam;
      this.userApiModule = userApiModuleParam;
      initialize(applicationContextModuleParam, dataSourceModuleParam, locationModuleParam, userApiModuleParam, userSourceModuleParam);

    }

    private LocationDataSourceImpl locationDataSourceImpl() {
      return new LocationDataSourceImpl(provideFusedLocationProviderClientProvider.get(), ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
    }

    private LocationRepositoryImpl locationRepositoryImpl() {
      return new LocationRepositoryImpl(provideLocationSourceProvider.get());
    }

    private LocationUseCase locationUseCase() {
      return LocationUseCaseModule_ProvideLocationUseCaseFactory.provideLocationUseCase(locationRepositoryImpl());
    }

    private UserSourceImpl userSourceImpl() {
      return new UserSourceImpl(provideLoginApiProvider.get());
    }

    private UserRepositoryImpl userRepositoryImpl() {
      return new UserRepositoryImpl(provideUserSourceProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final ApplicationContextModule applicationContextModuleParam,
        final DataSourceModule dataSourceModuleParam, final LocationModule locationModuleParam,
        final UserApiModule userApiModuleParam, final UserSourceModule userSourceModuleParam) {
      ...
      this.provideLocationSourceProvider = DoubleCheck.provider(new SwitchingProvider<LocationDataSource>(singletonCImpl, 0));
      ...
      this.provideUserSourceProvider = DoubleCheck.provider(new SwitchingProvider<UserSource>(singletonCImpl, 3));
      this.provideLoginUseCaseProvider = DoubleCheck.provider(new SwitchingProvider<LoginUseCase>(singletonCImpl, 2));
      this.provideRegisterUseCaseProvider = DoubleCheck.provider(new SwitchingProvider<RegisterUseCase>(singletonCImpl, 6));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.data.source.remote.LocationDataSource 
          return (T) DataSourceModule_ProvideLocationSourceFactory.provideLocationSource(singletonCImpl.dataSourceModule, singletonCImpl.locationDataSourceImpl());
          ...
          return (T) UserUseCaseModule_ProvideLoginUseCaseFactory.provideLoginUseCase(singletonCImpl.userRepositoryImpl());

          case 3: // com.example.data.source.remote.UserSource 
          return (T) UserSourceModule_ProvideUserSourceFactory.provideUserSource(singletonCImpl.userSourceModule, singletonCImpl.userSourceImpl());

          case 4: // com.example.data.source.UserApiService 
          return (T) UserApiModule_ProvideLoginApiFactory.provideLoginApi(singletonCImpl.userApiModule, singletonCImpl.provideRetrofitProvider.get());

          case 5: // retrofit2.Retrofit 
          return (T) NetworkModule_ProvideRetrofitFactory.provideRetrofit(NetworkModule_ProvideOkHttpClientFactory.provideOkHttpClient());

          case 6: // com.example.domain.usecase.RegisterUseCase 
          return (T) UserUseCaseModule_ProvideRegisterUseCaseFactory.provideRegisterUseCase(singletonCImpl.userRepositoryImpl());
