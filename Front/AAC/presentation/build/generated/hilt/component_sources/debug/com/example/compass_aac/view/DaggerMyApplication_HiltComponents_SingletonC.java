...
import com.example.compass_aac.module.DataSourceModule_ProvideFavoriteSourceFactory;
...
import com.example.compass_aac.module.UseCaseModule_ProvideFavoriteUseCaseFactory;
...
import com.example.compass_aac.view.favorite.FavoriteFullScreen;
...
import com.example.compass_aac.view.urgencyaac.AddSentence;
import com.example.compass_aac.view.urgencyaac.FullSrceen;
import com.example.compass_aac.view.urgencyaac.UrgencyCategory;
import com.example.compass_aac.view.urgencyaac.UrgencySentence;
...
import com.example.compass_aac.viewmodel.favorite.FavoriteMainViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.compass_aac.viewmodel.favorite.FavoriteVoiceViewModel;
import com.example.compass_aac.viewmodel.favorite.FavoriteVoiceViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    @Override
    public void injectDailyCategory(DailyCategory dailyCategory) {
    }

    @Override
    public void injectFavoriteFullScreen(FavoriteFullScreen favoriteFullScreen) {
    }

    @Override
    public void injectFavoriteMain(FavoriteMain favoriteMain) {
    }

    @Override
    public void injectSearchLocation(SearchLocation searchLocation) {
    }

    @Override
    public void injectLoginMain(LoginMain loginMain) {
    }

    @Override
    public void injectRegisterMain(RegisterMain registerMain) {
    }

    @Override
    public void injectTitleActivity(TitleActivity titleActivity) {
    }

    @Override
    public void injectAddSentence(AddSentence addSentence) {
    }

    @Override
    public void injectFullSrceen(FullSrceen fullSrceen) {
    }

    @Override
    public void injectUrgencyCategory(UrgencyCategory urgencyCategory) {
    }

    @Override
    public void injectUrgencySentence(UrgencySentence urgencySentence) {
    }

    @Override
    public void injectCustomizing(Customizing customizing) {
    }

    @Override
    public void injectUserPage(UserPage userPage) {
    }

    @Override
    public void injectChooseWordPass(ChooseWordPass chooseWordPass) {
    }

    @Override
    public void injectChooseWordVoice(ChooseWordVoice chooseWordVoice) {
    }

    @Override
    public void injectHearVoice(HearVoice hearVoice) {
    }

    @Override
    public void injectPassCategory(PassCategory passCategory) {
    }

    @Override
    public void injectShowSelectedWord(ShowSelectedWord showSelectedWord) {
    }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    private FavoriteVoiceUseCase favoriteVoiceUseCase() {
      return new FavoriteVoiceUseCase(singletonCImpl.textToSpeech(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.chooseWordPassViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.compass_aac.viewmodel.urgencyaac.CategoryViewModel 
          return (T) new CategoryViewModel(new UrgencyUseCase(), singletonCImpl.findNodeRepositoryImpl());

          case 1: // com.example.compass_aac.viewmodel.voiceaac.ChooseWordPassViewModel 
          return (T) new ChooseWordPassViewModel(singletonCImpl.findNodeRepositoryImpl());

          case 2: // com.example.compass_aac.viewmodel.voiceaac.ChooseWordVoiceViewModel 
          return (T) new ChooseWordVoiceViewModel(singletonCImpl.findNodeRepositoryImpl(), singletonCImpl.voiceUseCase());

          case 3: // com.example.compass_aac.viewmodel.favorite.FavoriteMainViewModel 
          return (T) new FavoriteMainViewModel(singletonCImpl.favoriteUseCase());
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private FavoriteSourceImpl favoriteSourceImpl() {
      return new FavoriteSourceImpl(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
    }

    private FavoriteSource favoriteSource() {
      return DataSourceModule_ProvideFavoriteSourceFactory.provideFavoriteSource(dataSourceModule, favoriteSourceImpl());
    }

    private FavoriteRepositoryImpl favoriteRepositoryImpl() {
      return new FavoriteRepositoryImpl(favoriteSource());
    }
    ...
    private FavoriteUseCase favoriteUseCase() {
      return UseCaseModule_ProvideFavoriteUseCaseFactory.provideFavoriteUseCase(favoriteRepositoryImpl(), textToSpeech());
    }
