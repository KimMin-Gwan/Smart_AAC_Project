...
public final class LocationViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    @org.jetbrains.annotations.NotNull
    private final androidx.lifecycle.MutableLiveData<kotlin.Result<java.util.List<com.example.domain.model.Categories>>> _categoryResult = null;
    ...
    @org.jetbrains.annotations.NotNull
    public final androidx.lifecycle.MutableLiveData<kotlin.Result<java.util.List<com.example.domain.model.Categories>>> get_categoryResult() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull
    public final androidx.lifecycle.LiveData<kotlin.Result<java.util.List<com.example.domain.model.Categories>>> getCategoryResult() {
        return null;
    }
