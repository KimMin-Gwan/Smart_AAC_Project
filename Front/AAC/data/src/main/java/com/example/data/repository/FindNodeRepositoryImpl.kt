...
class FindNodeRepositoryImpl @Inject constructor(@ActivityContext private val context:Context) :
    ...
    val node_urgency_list = MakeUrgencyNode()
    ...
    override fun MakeUrgencyNode(): NodeList {
        val node_maker = MakeUrgencyNode(context)
        val node_list : NodeList = node_maker.make_node_list()
    ...
    override fun RootUrgencyNode(selectedId: Int) {
        node_urgency_list.getNode(selectedId)
    }
    ...
    override fun getAAC_Tree(selectedId: Int) : ArrayList<Tree_Node>{
        ...
        val now_node: Tree_Node = aactree.getRootNode()
...
//                }
    ...
    //긴급
    override fun getAAC_Urgency_Tree(selectedId: Int) : ArrayList<Tree_Node>{
        node_urgency_list.getNode(selectedId)
        val aactree = AAC_Tree(selectedId, node_urgency_list)
        Log.d("AAC_Tree", aactree.getRootNode().getId().toString())
        val now_node: Tree_Node = aactree.getRootNode()
        Log.d("AAC_Tree", now_node.getId().toString())
